...
const LoginForm = ({ setLoggedInUser }) => {
  ...
  return (
    <Box className="login-page-root">
      ...
      <div className="login-bg-blob blob-1" aria-hidden="true" />
      <div className="login-bg-blob blob-2" aria-hidden="true" />

      <Paper elevation={0} className="login-card">
        <Box className="login-header">
          <Typography variant="h4" className="login-brand">
            SudoCart
          </Typography>
          <Typography variant="h5" className="login-subtitle">
            Welcome Back
          </Typography>
          <Typography variant="body2" className="login-helper">
            Login to continue shopping
          </Typography>
        </Box>
        ...
        <Typography className="login-register-text" variant="body2" align="center">
          Don&apos;t have an account?{' '}
          <Link component={RouterLink} to="/register" underline="none" className="login-register-link">
            Register
          </Link>
        </Typography>
      </Paper>
